  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center md:hidden">
        <div>
          <h3 className="pt-3 text-[12px]">Home / Reset Password</h3>
          <h1 className="text-[22px] py-2 font-semibold">Reset Password</h1>
        </div>
      ...
      <div className="hidden md:block">
        <h3 className="pt-3 text-[12px] md:text-14px">Home / Reset Password</h3>
        ...
        <div className="md:flex px-3 poppins pt-[35%] md:pt-[21%]">
            ...
            <div className="flex-col md:w-1/3 ">
                <h1 className='text-[16px] py-5'>Change Your Password</h1>
                   ...
                   <div className="flex gap-5 text-[10px] text-[#757575]">
                    ...
                    <CheckCircleIcon className=" w-full h-full" />
                        ...
                        <div className=" pt-[3px]">
                            <h1>At least 8-12 characters</h1>
                        </div>
                    </div>
                    <div className="flex">
                    <div className="w-6 h-6">
                    ...
                    <CheckCircleIcon className=" w-full h-full" />
                        ...
                        <div className="pt-[3px]">
                            <h1>Includes uppercase & lowercase letters</h1>
                        </div>
                    </div>
                    <div className="flex">
                    <div className="w-6 h-6">
                    <CheckCircleIcon className=" w-full h-full" />
                        ...
                        <div className="pt-[3px]">
                            <h1>At least one special character (!, @, #, etc.)</h1>
                        </div>
                    </div>
                        </div>
                   </div>
